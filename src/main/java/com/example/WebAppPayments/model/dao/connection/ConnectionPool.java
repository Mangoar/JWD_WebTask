package com.example.WebAppPayments.model.dao.connection;
...
public class ConnectionPool {
    ...
    private static final org.apache.log4j.Logger logger = Logger.getLogger(ConnectionPool.class);
    ...
    public ConnectionPool() {
        try {
            ...
            logger.info("CONNECTION POOL EXCEPTION", e);
        }
    }
