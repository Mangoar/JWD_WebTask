    ...
    <nav class="navbar navbar-expand-lg" style="margin-bottom: 0;">
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
            <div class="navbar-nav">
                ...
                <a class="nav-item nav-link" href="Controller?command=getpayments"
                   onmouseover="this.style.color='orange'; this.style.backgroundColor='#736AFF';" onmouseout="this.style.color=''; this.style.backgroundColor='';"
                   style="font-size: medium; height: 100%; margin-right: 15px;"><fmt:message key="my_payments"/></a>

                <a class="nav-item nav-link" href="Controller?command=getaccounts"
                   onmouseover="this.style.color='orange'; this.style.backgroundColor='#736AFF';" onmouseout="this.style.color=''; this.style.backgroundColor='';"
                   style="font-size: medium; height: 100%; margin-right: 15px;"><fmt:message key="my_accounts"/></a>
